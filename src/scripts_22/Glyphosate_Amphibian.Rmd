---
title: "Glyphosate Amphibian SSDs"
author: "Alex Dhond"
date: "11/9/2022"
...
This script develops and plots amphibian SSDs for glyphosate using both surrogate and prediction data. The data was provided by Annie and Tom. 
...
# SURROGATE DATA
In this code section I will create multiple SSDs for Glyphosate based on the SURROGATE data.
...
# Plot the SSD for the Glyphosate surrogate data
```{r}
...
# Plot the SSD for the Glyphosate prediction data
```{r}
# Filter the data to only include surrogate species for glyphosate
gly_pred <- glyphosate %>%
